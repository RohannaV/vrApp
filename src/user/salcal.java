...
public class salcal extends javax.swing.JFrame {
    ...
    public void deduction(){
        ...
        String query = "SELECT sss, pagibig, philhealth FROM employee WHERE e_id='"+sad.getText()+"' ";
...
//            
            String ss = rs.getString("sss");
            String pag = rs.getString("pagibig");
            String phil = rs.getString("philhealth");
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        ...
        txtbill.setText(txtbill.getText() + "\n---------------------------------------------------------------------------------" +  "\n");
        txtbill.setText(txtbill.getText() + "\n\tBasic Salary:" + " " + txtallow.getText() + "\n");
        txtbill.setText(txtbill.getText() + "\n\tDays of Duty:" + " " + txtother.getText() + "\n");
    ...
    public javax.swing.JTextField txtallow;
